...
public class LogAntifraude {
    ...
    public String getResultadoRisco() { return resultadoRisco; }
    public void setResultadoRisco(String resultadoRisco) { this.resultadoRisco = resultadoRisco; }

    public Integer getScoreCalculado() { return scoreCalculado; }
    public void setScoreCalculado(Integer scoreCalculado) { this.scoreCalculado = scoreCalculado; }
